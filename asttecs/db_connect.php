...
* Revision 0.044  2007/09/7 17:55:00  last modified by philip
...
// mysql connection
mysql_connect($config['database']['dbhost'],$config['database']['username'],$config['database']['password']) or die ('MySql connect failed. '. mysql_error());
mysql_select_db($config['database']['dbname']) or die('Cannot select database.' . mysql_error());
?>

...
require_once ('backup.grid.inc.php');
...
//-- mypart	$headers[] = $locate->Translate("Reseller");
...
//-- mypart	$attribsHeader[] = 'width="15%"';
	...
	$attribsCols[] = 'style="text-align: left"';
	$attribsCols[] = 'style="text-align: left"';
//-- mypart	$attribsCols[] = 'style="text-align: left"';
	//$attribsCols[] = 'style="text-align: left"';
	$attribsCols[] = 'style="text-align: left"';
	$attribsCols[] = 'style="text-align: left"';
...
//-- mypart	$eventHeader[]= 'onClick=\'xajax_showGrid(0,'.$limit.',"'.$filter.'","'.$content.'","resellername","'.$divName.'","ORDERING");return false;\'';
...
//-- mypart	$fieldsFromSearch[] = 'resellername';
...
//-- mypart	$fieldsFromSearchShowAs[] = $locate->Translate("Reseller");
//	$fieldsFromSearchShowAs[] = $locate->Translate("Group");
	...
	// Change here by the name of fields of its database table
		...
		$rowc[] = $row['password'];
		$rowc[] = $row['usertype'];
	//-- mypart	$rowc[] = $row['resellername'];
	//	$rowc[] = $row['groupname'];
		$rowc[] = $row['addtime'];
		$table->addRow("account",$rowc,1,1,0,$divName,$fields);
 	}
...
/* mypart	if ( $f['resellerid'] == 0 && $f['usertype'] == 'reseller' ){

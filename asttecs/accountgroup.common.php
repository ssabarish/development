<?php
/*******************************************************************************
* accountgroup.common.php
* accountgroup参数信息文件

* accountgroup parameter file
...
*	such as xajax_init()
	...
	showGrid
	add					show accountgroup add form
	save				save accountgroup information
	edit				show accountgroup edit form
	update				update accountgroup information
	delete				delete an accountgroup
	showDetail			show detail information about an accountgroup
						return null for now
	init				init html page
...
$xajax = new xajax("accountgroup.server.php");

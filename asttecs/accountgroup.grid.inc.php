...
* @author			Solo Fu <jissphilip@gmail.com>
* @classVersion		1.0
* @date				18 Oct 2007
...
class Customer extends astercrm
{
	...
	*/
	function &getAllRecords($start, $limit, $order = null, $creby = null){
		...
		$sql = "SELECT accountgroup.* FROM accountgroup ";
	...
	*/
	...
	function &getRecordsFilteredMore($start, $limit, $filter, $content, $order,$table, $ordering = ""){
		...
		$sql = "SELECT accountgroup.* FROM  WHERE ";
	...
	*/
	...
	function &getNumRows($filter = null, $content = null){
		...
		if ($_SESSION['curuser']['usertype'] == 'admin'){
			...
			$sql = "SELECT COUNT(*) AS numRows FROM accountgroup  WHERE accountgroup.resellerid = ".$_SESSION['curuser']['resellerid']." ";
		}
	...
	function &getNumRowsMore($filter = null, $content = null,$table){
		global $db;
			...
			$sql = 'SELECT COUNT(*) AS numRows FROM accountgroup  WHERE ';
	...
	function &getRecordsFilteredMorewithstype($start, $limit, $filter, $content, $stype,$order,$table){
		...
		$sql = "SELECT accountgroup.* FROM accountgroup  WHERE ";
	...
	$html = '
			...
			<table border="1" width="100%" class="adminlist">
				...
				<tr>
					...
					<td align="left"><input type="text" id="grouplogo" name="grouplogo" size="25" maxlength="30"></td>
				</tr>
		...
		if ($_SESSION['curuser']['usertype'] == 'admin' || $_SESSION['curuser']['allowcallback'] == 'yes'){
			...
			$html .= '<option value="no">'.$locate->Translate("No").'</option>';
				...
				<tr>
				  ...
				  <tr>
                                        <td nowrap align="left">'.$locate->Translate("Tax").'*</td>
                                        <td align="left"><input type="text" id="tax" name="tax" size="25" maxlength="30" value="'.$group['tax'].'"></td>
                                </tr>

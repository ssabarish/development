...
function btnReceiptOnClick(divId){
	...
	window.open ("receipt.php?peer="+divId+"&customername="+customername+"&discount="+discount+"", 'Receipt', 'height=1000, width=1200, toolbar=no, menubar=no, scrollbars=yes, resizable=yes, location=no, status=no');
}
